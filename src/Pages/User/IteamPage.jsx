...
export const IteamPage = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axiosInstance.get(`/Product/getfoodById/${id}`);
  ...
  if (loading) return <div className="text-center text-lg py-10 animate-pulse">Loading Product...</div>;
